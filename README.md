...
npm -v
npx -v
If any of these commands are "not recognized", install Node.js from: Node.js Download Page
...
If you get a version number (e.g. 11.6.2), you’re good to go. If not, reinstall Node.js and make sure “Add to PATH” is checked during setup.
